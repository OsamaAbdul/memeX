// prettier-ignore
export default {
  leftPanelContainer: 'left-panel-container flex flex-col w-full h-full gap-8 lg:gap-0 py-4 p-4 transition-all duration-200 ease-out',
  leftPanelContainerOpen: 'left-panel-container-open rounded-t-2xl lg:rounded-t-none p-4',
